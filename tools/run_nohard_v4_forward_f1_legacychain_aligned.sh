...
container_name=nohard-v4-forward-f1-legacychain-aligned-c15850-300
parent_run=Sep15_01-55-29_nohard_v4_fromzero_17200chain_low065_filter6speed_arm002_seed33_c15750_to16050
run_name=nohard_v4_forward_f1_legacychain_aligned_costoff_from_c15850_300
...
docker run -d --name "$container_name" --gpus all --ipc=host --shm-size=16g \
  ...
  --max_iterations 300 --save_interval_override 50 \
  ...
  --task_event_require_success_height 1 \
  --jumping_scale_override 200 \
  ...
  --task_max_height_scale_override 5000 \
  --base_height_flight_scale_override 100 \
  --push_towards_goal_probability_override .8 \
  --push_towards_goal_final_probability_override .8 \
  ...
  --run_name "$run_name" \
  --effective_config_output /workspace/project/artifacts/velocity_recovery_20260913/nohard_v4_forward_f1_legacychain_aligned_c15850_300_effective.json
