...
container_name=nohard-v4-forward-f1-heightgate-joint500-jump1000-c15850-100
parent_run=Sep15_01-55-29_nohard_v4_fromzero_17200chain_low065_filter6speed_arm002_seed33_c15750_to16050
run_name=nohard_v4_forward_f1_heightgate_joint500_jump1000_costoff_from_c15850_100
...
docker run -d --name "$container_name" --gpus all --ipc=host --shm-size=16g \
  ...
  --run_name "$run_name" \
  --effective_config_output /workspace/project/artifacts/velocity_recovery_20260913/nohard_v4_forward_f1_heightgate_joint500_jump1000_c15850_100_effective.json
