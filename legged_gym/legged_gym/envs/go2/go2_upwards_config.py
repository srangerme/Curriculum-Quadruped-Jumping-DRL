...
class Go2UpwardsCfg( LeggedRobotCfg ):
    task_name = 'go2_upwards'
    class init_state( LeggedRobotCfg.init_state ):
        pos = [0.0, 0.0, 0.32] # x,y,z [m]
        rel_foot_pos = [[0.1934,0.1934,-0.1934,-0.1934], # x
                        [0.142,-0.142,0.142,-0.142], # y
...
class Go2UpwardsCfgPPO( LeggedRobotCfgPPO ):
